...
class ImageManipulatorView extends Component {
  constructor(props) {
      ...
      Image.getSize(uri, (actualWidth, actualHeight) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          if (cropObj.height > 0 && cropObj.width > 0) {
            let uriToCrop = uri;
            if (this.isRemote) {
              const response = yield FileSystem.downloadAsync(
                uri,
            ...
            } = yield this.crop(cropObj, uriToCrop);
    ...
    this.onRotateImage = () =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        Image.getSize(uri, (width, _height) =>
          __awaiter(this, void 0, void 0, function* () {
    ...
    this.onFlipImage = (orientation) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        Image.getSize(uri, () =>
          __awaiter(this, void 0, void 0, function* () {
            const { uri: rotUri, base64 } = yield this.flip(
              uriToCrop,
              orientation,
            );
            this.setState({ uri: rotUri, base64 });
    ...
    this.flip = (uri, orientation) =>
      __awaiter(this, void 0, void 0, function* () {
        const { saveOptions } = this.props;
        return yield ImageManipulator.manipulateAsync(
          uri,
          [
            {
              flip: orientation,
  ...
  onConvertImageToEditableSize() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.setState(this.initialState, () => {
        ...
        Image.getSize(rawUri, (imgW, imgH) =>
          __awaiter(this, void 0, void 0, function* () {
            ...
            const {
              ...
              width: w,
              height,
            } = yield ImageManipulator.manipulateAsync(
              rawUri,
              [
                {
                  resize: {
  ...
  render() {
    ...
    const screenHeight =
      Dimensions.get("window").height - this.state.safeAreaHeight;
    const screenRatio = screenHeight / screenWidth;
    let cropWidth = screenWidth;
    let cropHeight =
      imageRatio < screenRatio ? screenWidth * imageRatio : screenHeight - 200;
    let cropMinWidth = 60;
    ...
    const cropInitialTop =
      (Math.min(this.state.imageLayout.height, screenHeight) - cropHeight) /
        2.0 +
    ...
    return React.createElement(
      ...
      React.createElement(
        SafeAreaView,
        {
          ...
          onLayout: (e) =>
            this.setState({ safeAreaHeight: e.nativeEvent.layout.height }),
        },
        React.createElement(
          ScrollView,
          {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          cropMode &&
            React.createElement(ImageCropOverlay, {
...
ImageManipulatorView.defaultProps = {
  ...
  icons: {
    back: React.createElement(MaterialIcons, {
      size: 24,
      name: "arrow-back-ios",
      color: "white",
    }),
    crop: React.createElement(FontAwesome, {
      style: { marginRight: 5 },
      size: 20,
      name: "scissors",
      color: "white",
    }),
    processing: React.createElement(MaterialIcons, {
      style: { marginRight: 5 },
      size: 20,
      name: "access-time",
      color: "white",
